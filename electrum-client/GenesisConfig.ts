    ...
    private static readonly CONFIGS: {[name in Network]: GenesisConfigConfig} = {
        'bitcoin': {
            ...
            SEED_PEERS: [
                ...
                // This list of seeds is generated from the seeds of Electrum Wallet
                // https://github.com/spesmilo/electrum/blob/master/electrum/servers.json
                // GENERATED MAINNET SEEDS >>>
                ...
                {host: 'bitcoin.aranguren.org', ports: {wss: null, ssl: 50002, tcp: 50001}, ip: '', version: '1.4.2'},
                {host: 'bitcoin.lukechilds.co', ports: {wss: null, ssl: 50002, tcp: 50001}, ip: '', version: '1.4.2'},
                {host: 'electrum.aantonop.com', ports: {wss: null, ssl: 50002, tcp: 50001}, ip: '', version: '1.4.2'},
                {host: 'electrum.blockstream.info', ports: {wss: null, ssl: 50002, tcp: 50001}, ip: '', version: '1.4'},
                // <<< GENERATED MAINNET SEEDS
            ],
            SEED_LISTS: [
        ...
        'testnet': {
            ...
            SEED_PEERS: [
                ...
                // GENERATED TESTNET SEEDS >>>
                {host: 'electrum.blockstream.info', ports: {wss: null, ssl: 60002, tcp: 60001}, ip: '', version: '1.4'},
                // <<< GENERATED TESTNET SEEDS
            ],
            SEED_LISTS: [],
